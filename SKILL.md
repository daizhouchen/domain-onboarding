...
v1.4 规则里"首次注释一次后续保留英文"这条只对**圈内通行的英文**（HNSW / RAG / API / IMF / BIS）成立。
**已通行的中译**（凯恩斯 / 布雷顿森林 / 广场协议 / 美联储 / 世界银行 / 彭博 / 路透 / 加州伯克利大学
/ 哈佛 / 牛津 / 索罗斯 / 特里芬 / 艾肯格林 / 英伟达 / 央行 / 美债 / 美国财政部 / 外行 / 在位者）
**全文用中文**，首次出现可酌情加一次英文括号，**后续必须全中文**——v1.4 写法（首次注释后仍英文）
被用户反复反馈"看着割裂"。

完整 50+ 词通行中译表 + 决策树 + 全章扫描自检清单见 `references/narrative-style-guide.md` 的
"v1.5 通行中译必用中文"章节。
